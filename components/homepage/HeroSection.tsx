...
export default function HeroSection({ hero }: { hero: THero }) {
  return (
    <div className="relative z-10 mx-auto max-w-4xl px-6 pb-10 pt-20 text-center">
      ...
      <motion.h1
        {...fu(0.2)}
        className="mb-4 bg-gradient-to-r from-teal-300 via-cyan-300 to-teal-400 bg-clip-text text-5xl font-black leading-tight tracking-tight text-transparent lg:text-7xl capitalize"
      >
        {hero.name}
      </motion.h1>
      ...
      <motion.p
        {...fi(0.4)}
        className="mb-3 text-xl font-semibold text-slate-300 capitalize"
      >
